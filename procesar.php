...
$base_de_datos = "datos_personales"; // Cambiar al nombre de tu BD
...
$sql = "INSERT INTO T_datospersonales5 (nombre_tarea, descripcion, email, fecha, telefono) VALUES ('$nombre', '$descripcion', '$email','$fecha','$telefono')";
